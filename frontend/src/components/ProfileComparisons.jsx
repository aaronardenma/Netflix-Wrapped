  ...
  return (
    <section className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-lg border border-neutral-200 bg-white p-4 shadow-sm">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h3 className="font-bold text-neutral-950">Watch Time By Profile</h3>
          </div>
          <div className="space-y-3">
            {comparisons.profile_watchtime.map((item) => (
              <div key={item.profile}>
                <div className="mb-1 flex items-center justify-between text-sm">
                  <span className="font-semibold text-neutral-700">{item.profile}</span>
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-4 shadow-sm">
          <h3 className="mb-4 font-bold text-neutral-950">Most Unique Profile</h3>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-lg border border-neutral-200 bg-white p-4 shadow-sm">
          <h3 className="mb-4 font-bold text-neutral-950">Overlap With {comparisons.selected_profile}</h3>
          <div className="space-y-3">
            {comparisons.overlap_scores?.length ? (
              comparisons.overlap_scores.map((item) => (
                <div key={item.profile} className="flex items-center justify-between gap-4">
                  <span className="text-sm font-semibold text-neutral-700">{item.profile}</span>
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-4 shadow-sm">
          <h3 className="mb-4 font-bold text-neutral-950">Shared Titles</h3>
          <div className="space-y-3">
